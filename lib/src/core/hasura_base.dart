...
import 'package:hasura/src/snapshot/snapshot_data.dart';
...
class HasuraConnectBase implements HasuraConnect {
  ...
  HasuraConnectBase(this.url,
    ...
    _reconnectionAttemp = reconnectionAttemp;
  }
  ...
  void _connect() async {
    if (_reconnectionAttemp != null && _reconnectionAttemp > 0) {
      if (_numbersOfConnectionAttempts >= _reconnectionAttemp) {
